...
public class JsonResultAdmin {
    /**
     * 0代表成功大于0的为不同的错误
     *
     */
    private static final int DEFAULT_CODE_SUCCESS = 0;
    private static final int DEFAULT_CODE_FAIL = 1;

    private static final String DEFAULT_CODE_KEY = "code";
    private static final String DEFAULT_MESSAGE_KEY = "msg";
    private static final String DEFAULT_DATA_KEY = "data";

    private JsonResultAdmin()
    {
    ...
    {
        return build(DEFAULT_CODE_KEY,DEFAULT_CODE_SUCCESS);
    }

    public static JsonData success(Object code)
    {
        return build(DEFAULT_CODE_KEY,code);
    }
    ...
    {
        return build(DEFAULT_CODE_KEY,DEFAULT_CODE_FAIL);
    }
    ...
    public static JsonData fail(String codeKey, Object value)
    {
        return build(codeKey,value);
    }


    public static JsonData build(String key, Object value)
    {
        JsonData jsonData = new JsonResultAdmin().new JsonData(4);
    ...
    {
        return new JsonResultAdmin().new JsonData();
    ...
    public static JsonData build(DataMap dataMap)
    {
       JsonData jsonData = new JsonResultAdmin().new JsonData(4);
        ...
        {
            jsonData.put(DEFAULT_CODE_KEY,dataMap.getCode());
        }
        else
        {
            if (dataMap.getSuccess() != null)
            {
                ...
                {
                    jsonData.put(DEFAULT_CODE_KEY,DEFAULT_CODE_SUCCESS);

                }
                else
                {
                    jsonData.put(DEFAULT_CODE_KEY,DEFAULT_CODE_FAIL);
    ...
    public class JsonData extends LinkedHashMap<Object,Object>
    {
