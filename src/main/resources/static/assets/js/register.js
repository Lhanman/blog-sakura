...
registerFormBtn.click(function () {
    ...
    if (phone_value !== 0 && auth_code_value !== 0 && username_value !== 0
        && password_value !== 0 && (radio_input[0].checked || radio_input[1].checked)) {
...
//注册成功的显示
function putInSuccess() {
    register_clear.html('');
    var sec = $('<div class="register_success"></div>');
    var register_success_img = $('');
