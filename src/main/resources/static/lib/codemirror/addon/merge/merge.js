...
(function(mod) {
  ...
  function syncScroll(dv, type) {
    ...
    // Don't take action if the position of this editormd was recently set
  ...
  // Updating the marks for editormd content
  ...
  // Updating the gap between editormd and original
